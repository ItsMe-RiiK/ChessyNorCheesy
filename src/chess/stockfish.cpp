...
bool StockfishEngine::is_running() const
{
  return child_pid_ > 0;
}
...
bool StockfishEngine::set_threads(int n)
{
  return set_option("Threads", std::to_string(n));
}

bool StockfishEngine::set_hash(int mb)
{
  return set_option("Hash", std::to_string(mb));
}

std::string StockfishEngine::get_engine_info() const
{
  return engine_info_;
}

int StockfishEngine::get_last_score() const
{
  return last_score_;
}

std::string StockfishEngine::get_last_pv() const
{
  return last_pv_;
}
